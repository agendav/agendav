...
calendar_modify_form(this)});update_calendar_list(!0);$("#calendar_list_refresh").click(function(){update_calendar_list(!0)});$("#calendar_add").click(calendar_create_form);$("#shortcut_add_event").button({icons:{primary:"ui-icon-plusthick"}}).bind("click",function(){var a={start:fulldatetimestring($("#calendar_view").fullCalendar("getDate")),allday:!1,view:"month",current_calendar:$("#calendar_list li.selected_calendar").data().calendar};$("#calendar_view").fullCalendar("unselect");event_field_form("new",
a)})});function calendar_height(){return $(window).height()-24-25-$("#footer").height()}function show_error(a,b){$("#popup").freeow(a,b,{classes:["popup_error"],autoHide:!1,showStyle:{opacity:1,left:0},hideStyle:{opacity:0,left:"400px"}})}function show_success(a,b){$("#popup").freeow(a,b,{classes:["popup_success"],autoHide:!0,autoHideDelay:2E3,showStyle:{opacity:1,left:0},hideStyle:{opacity:0,left:"400px"}})}function get_data(a){return $("body").data(a)}
function set_data(a,b){$("body").data(a,b)}
function load_generated_dialog(a,b,c,d,e,f,h){f="#"+f;if($(f).length!=0)return!1;b=generate_on_the_fly_form(base_app_url+"caldav2json/edit_event",b);if(get_data("formcreation")=="ok"){b=$("#"+b);$(b).attr("action");var g=$(b).serialize();$.ajax({url:base_app_url+a,beforeSend:function(){$("body").mask(_("messages","overlay_loading_dialog"),500)},complete:function(){$("body").unmask()},cache:!1,type:"POST",data:g,dataType:"html",error:function(a,b){show_error(_("messages","error_loading_dialog"),_("messages",
"error_oops")+": "+b)},success:function(a){$("body").append(a);$(f).dialog({autoOpen:!0,buttons:e,title:d,minWidth:h,modal:!0,open:function(a){c();$(f).dialog("option","position","center");a=$(a.target).parent().find(".ui-dialog-buttonset").children();add_button_icons(a)},close:function(){$(this).remove()}})}});$(b).remove()}else show_error(_("messages","error_interfacefailure"),_("messages","error_oops"))}
...
function generate_on_the_fly_form(a,b){for(var c="",d=0;d<10;d++)c+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(Math.floor(Math.random()*62));$.ajax({url:base_app_url+"dialog_generator/on_the_fly_form/"+c,cache:!1,type:"POST",contentType:"text",dataType:"text",async:!1,error:function(a,b){show_error(_("messages","error_genform"),b);set_data("formcreation","failed")},success:function(e){$("body").append(e);$("#"+c).attr("action",a);$.each(b,function(a,b){$("#"+c).append('<input type="hidden" name="'+
...
"delete_calendar_dialog",500)}},{text:_("labels","save"),"class":"addicon btn-icon-calendar-edit",click:function(){var a=$("#modify_calendar_form");proceed_send_ajax_form(a,function(){destroy_dialog(mcd);update_calendar_list(!1)},function(a){show_error(_("messages","error_invalidinput"),a)},function(){})}},{text:_("labels","cancel"),"class":"addicon btn-icon-cancel",click:function(){destroy_dialog(mcd)}}];c.shared===!0&&e.splice(0,1);load_generated_dialog("dialog_generator/modify_calendar",d,function(){$("input.pick_color").colorPicker();
