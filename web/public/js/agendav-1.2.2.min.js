...
orig_start:fulldatetimestring($.fullCalendar.parseDate(a.orig_start)),orig_end:fulldatetimestring($.fullCalendar.parseDate(a.orig_end))},$(this).parents(ved).qtip("hide"),event_field_form("modify",a),!1});$("li.available_calendar").live("click",function(){$("#calendar_list li.selected_calendar").removeClass("selected_calendar");$(this).addClass("selected_calendar")});$("li.available_calendar").live("dblclick",function(a){a.preventDefault();calendar_modify_form(this)});update_calendar_list(!0);$("#calendar_list_refresh").click(function(){update_calendar_list(!0)});
$("#calendar_add").click(calendar_create_form);$("#shortcut_add_event").button({icons:{primary:"ui-icon-plusthick"}}).bind("click",function(){var a={start:fulldatetimestring($("#calendar_view").fullCalendar("getDate")),allday:!1,view:"month",current_calendar:$("#calendar_list li.selected_calendar").data().calendar};$("#calendar_view").fullCalendar("unselect");event_field_form("new",a)})});function calendar_height(){return $(window).height()-24-25-$("#footer").height()}
...
$("#"+f).dialog({autoOpen:!0,buttons:e,title:d,minWidth:h,modal:!0,open:function(a){c();$("#"+f).dialog("option","position","center");a=$(a.target).parent().find(".ui-dialog-buttonset").children();add_button_icons(a)},close:function(){$(this).remove()}})}});$(b).remove()}else show_error(_("messages","error_interfacefailure"),_("messages","error_oops"))}
...
function generate_event_source(a){return{url:base_app_url+"caldav2json/events#"+a,cache:!1,data:{calendar:a},error:function(){show_error(_("messages","error_interfacefailure"),_("messages","error_loadevents",{"%cal":a}))},startParamUTC:!0,endParamUTC:!0}}
