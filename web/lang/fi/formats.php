 ...
 */
$formats['full_date_strftime'] = '%a %e %B %Y';
...
$formats['column_table_fullcalendar'] = 'MMM d, yyyy';
$formats['title_month_fullcalendar'] = 'MMMM yyyy';
$formats['title_week_fullcalendar'] = "MMM d[ yyyy]{ '&#8212;'[ MMM] d yyyy}";
$formats['title_day_fullcalendar'] = 'dddd, MMM d yyyy';
