...
$translations = array(
    ...
    'labels.sunday_short' => 'Paz',
    'labels.monday_short' => 'Pzt',
    'labels.tuesday_short' => 'Sal',
    'labels.wednesday_short' => 'Çrş',
    'labels.thursday_short' => 'Prş',
    'labels.friday_short' => 'Cum',
    'labels.saturday_short' => 'Cts',


    'labels.calendar' => 'Takvim',
    'labels.location' => 'Konum',
    'labels.description' => 'Açıklama',

    'labels.displayname' => 'Ekran İsmi',
    'labels.color' => 'Renk',
    ...
    'labels.alldayform' => 'Tüm Gün',
    'labels.choose_date' => 'Bir Tarih Seçin',

    'labels.repeat' => 'Tekrar',
    'labels.repeatno' => 'No repetitions',
    'labels.repeatdaily' => 'Günlük',
    'labels.repeatweekly' => 'Haftalık',
    'labels.repeatmonthly' => 'Aylık',
    'labels.repeatyearly' => 'Yıllık',

    'labels.privacy' => 'Gizlilik',
    'labels.public' => 'Genel',
    'labels.private' => 'Özel',
    'labels.confidential' => 'Gizli',

    'labels.transp' => 'Show this time as',
    'labels.opaque' => 'Meşgul',
    'labels.transparent' => 'Ücretsiz',

    'labels.generaloptions' => 'Genel Ayarlar',
    'labels.repeatoptions' => 'Tekrar',
    'labels.workgroupoptions' => 'Çalışma Grubu',
    'labels.shareoptions' => 'Paylaş',

    'labels.newcalendar' => 'Yeni Takvim',
    'labels.modifycalendar' => 'Takvim Değiştir',
    'labels.deletecalendar' => 'Takvim Sil',

    'labels.createevent' => 'Olay Oluştur',
    'labels.editevent' => 'Olay Düzenle',
    'labels.deleteevent' => 'Olay Sil',

    'labels.calendars' => 'Takvimler',
    'labels.shared_calendars' => 'Paylaşılan Takvimler',
    ...
    'labels.login' => 'Giriş Yap',
    'labels.logout' => 'Çıkış',
    'labels.modify' => 'Düzenle',
    'labels.cancel' => 'İptal',
    'labels.yes' => 'Evet',
    'labels.no' => 'No',
    ...
    'labels.readonly' => 'Oku',
    'labels.readandwrite' => 'Oku ve Yaz',

    'labels.preferences' => 'Tercihler',
    'labels.return' => 'Geri Dön',

    'labels.defaultcalendar' => 'Varsayılan Takvim',
    'labels.default_view' => 'Default view',

    'labels.toggleallcalendars' => 'Göster/Gizle',

    'labels.minutes' => 'dakikalar',
    'labels.hours' => 'saatler',
    'labels.days' => 'günler',
    'labels.weeks' => 'haftalar',
    'labels.months' => 'aylar',

    'labels.remindersoptions' => 'Hatırlatmalar',
    'labels.reminder' => 'Hatırlatma',

    'labels.add_reminder' => 'Hatırlatma Ekle',
...
// Messages
    ...
    'messages.info_confirmcaldelete' => 'Takvimi silmek istediğinizden emin misiniz?',
    ...
    'rrule.time' => 'time',
    'rrule.times' => 'times',
    'rrule.weekday' => 'iş günü',
    'rrule.weekdays' => 'iş günleri',
    'rrule.in' => 'içinde',
    'rrule.on the' => 'on the',
    'rrule.and' => 've',
    'rrule.or' => 'veya',
