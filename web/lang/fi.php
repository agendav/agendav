...
$translations = array(
    ...
    'labels.occurrences' => 'ilmentymiä',

    'labels.timezone' => 'Aikavyöhyke',
    'labels.every' => 'Every',
    'labels.repeat_by_day' => 'Repeat on',
    'labels.repeat_by_month_day' => 'Day of month',
    'labels.repeat_explanation' => 'Tämä tapahtuma toistuu',
    'labels.keep_rrule' => 'Säilytä alkuperäinen toistumissääntö',
