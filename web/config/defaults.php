...
|--------------------------------------------------------------------------
|
| Set this to true to log all requests and responses made by AgenDAV to
| $log_path/http.log
|
| Be careful when enabling this setting, performance will be affected and
| log file will grow very fast.
|
*/
