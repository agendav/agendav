...
$translations = array(
    ...
    'labels.delete_only_this_repetition' => 'Borrar solo ésta',
    'labels.delete_all_repetitions' => 'Borrar todas las repeticiones',

    'labels.edit_only_this_repetition' => 'Editar solo ésta',
    'labels.edit_all_repetitions' => 'Editar todas las repeticiones',
    ...
    'labels.add_reminder' => 'Nuevo recordatorio',
    'labels.add_share' => 'Añadir compartición',

    'labels.before_start' => 'antes de empezar',
    'labels.after' => 'Tras',
    ...
    'labels.ends' => 'Acaba:',
    'labels.never' => 'Nunca',
    'labels.occurrences' => 'repeticiones',

    'labels.timezone' => 'Zona horaria',
    'labels.every' => 'Cada',
    'labels.repeat_by_day' => 'Repetir los',
    'labels.repeat_by_month_day' => 'Día del mes',
    'labels.repeat_explanation' => 'Este evento se repite',
    'labels.keep_rrule' => 'Mantener regla de repetición original',

    'labels.language' => 'Idioma',
    'labels.date_format' => 'Formato de fecha',
...
// Messages
    ...
    'messages.info_base_event_with_exceptions_modification' => 'Este evento repetitivo tiene una o más excepciones añadidas. Si usa el botón "Editar todas las repeticiones", se borrarán las excepciones',
    'messages.info_delete_recurrent_event' => 'Este evento se repite. ¿Quiere eliminar solo esta repetición o todas? ',
    'messages.info_delete_recurrent_event_first_instance' => 'Este evento se repite, y ésta es la primera repetición. Si la elimina, todas las demás repeticiones se eliminarán. ¿Está seguro?',
...
calendarios',
    ...
    'messages.error_element_not_found' => 'Elemento no encontrado',
...
existen',
    ...
    'messages.info_reminders_agendav_support' => 'Nota: las notificaciones serán mostradas únicamente en clientes CalDAV compatibles. AgenDAV no puede mostrarlas',

    'messages.request_error' => 'Hay un error en su petición',
    'messages.page_not_found' => 'Página no encontrada',
    'messages.internal_server_error' => 'Error interno del servidor',
    ...
    'rrule.year' => 'año',
    'rrule.years' => 'años',
    'rrule.for' => 'un total de',
    'rrule.on' => 'el',
    'rrule.time' => 'vez',
    'rrule.times' => 'veces',
    'rrule.weekday' => 'entre semana',
    'rrule.weekdays' => 'días entre semana',
    'rrule.in' => 'en',
    'rrule.on the' => 'el',
    'rrule.and' => 'y',
    'rrule.or' => 'o',
    'rrule.the' => 'el',
    'rrule.last' => 'el último',
